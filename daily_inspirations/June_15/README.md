...
1. Cherry-pick the matching nano_templates.json delta from
   hongjie28-patch-2 (per memory feedback_hongjie_patch_branches.md)
2. Run scripts/add_hongjie28_patch2_v<N>_i18n.py for the new templates
   (10-locale i18n in same workflow, per feedback_daily_drop_i18n.md)
3. node scripts/sync_nano_inspiration.cjs --supabase
4. bash scripts/sync_large_assets.sh
5. Commit + push curify-frontend; delete remote hongjie28-patch-2.
